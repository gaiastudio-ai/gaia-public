...
- For ADR lookups, reference the inline decision log in `docs/planning-artifacts/architecture/architecture.md §Decision Log` — ADRs live inline in that table rather than in a separate ADR directory.
