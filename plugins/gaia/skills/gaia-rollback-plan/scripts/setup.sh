#!/usr/bin/env bash
# setup.sh — Cluster 12 gaia-rollback-plan skill setup (E28-S94)
#
...
#   2. Run validate-gate.sh prereq check (AC-EC1, AC-EC5)
...
SCRIPT_NAME="gaia-rollback-plan/setup.sh"
WORKFLOW_NAME="rollback-plan"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-rollback-plan/scripts/setup.sh → ../../../scripts
...
# ---------- 2. Validate gate — dependency check (AC-EC1, AC-EC5) ----------
