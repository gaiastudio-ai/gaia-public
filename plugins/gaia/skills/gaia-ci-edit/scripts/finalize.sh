#!/usr/bin/env bash
# finalize.sh — Cluster 11 gaia-ci-edit skill finalize (E28-S86)
#
...
#   1. Invoke validate-gate.sh for post-edit CI gate verification (AC3)
...
# ---------- 1. Post-edit gate verification via validate-gate.sh (AC3) ----------
