#!/usr/bin/env bash
# setup.sh — Cluster 9 gaia-test-automate skill setup (E28-S69)
#
...
SCRIPT_NAME="gaia-test-automate/setup.sh"
WORKFLOW_NAME="test-automate"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-test-automate/scripts/setup.sh → ../../../scripts
