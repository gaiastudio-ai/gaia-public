...
SCRIPT_NAME="gaia-fill-test-gaps/setup.sh"
WORKFLOW_NAME="fill-test-gaps"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-fill-test-gaps/scripts/setup.sh → ../../../scripts
...
# The skill body handles missing gap reports with a descriptive error (AC-EC3).
