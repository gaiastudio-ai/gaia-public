#!/usr/bin/env bash
# setup.sh — correct-course skill setup (E28-S63)
#
...
SCRIPT_NAME="gaia-correct-course/setup.sh"
WORKFLOW_NAME="correct-course"
...
# correct-course requires sprint-status.yaml to exist.
