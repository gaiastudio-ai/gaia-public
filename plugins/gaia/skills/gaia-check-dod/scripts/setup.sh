#!/usr/bin/env bash
# setup.sh — Cluster 7 check-dod skill setup (E28-S56)
#
...
SCRIPT_NAME="gaia-check-dod/setup.sh"
WORKFLOW_NAME="check-dod"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-check-dod/scripts/setup.sh → ../../../scripts
