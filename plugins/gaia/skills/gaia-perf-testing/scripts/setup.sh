#!/usr/bin/env bash
# setup.sh — Cluster 12 gaia-perf-testing skill setup (E28-S88)
#
...
SCRIPT_NAME="gaia-perf-testing/setup.sh"
WORKFLOW_NAME="performance-testing"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-perf-testing/scripts/setup.sh → ../../../scripts
