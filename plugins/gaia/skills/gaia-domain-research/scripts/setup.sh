...
# domain-research's legacy workflow had no hard prereqs — it is an entry-point
...
# (domain, focus areas) are elicited by the skill body itself in Step 1,
# matching the legacy instructions.xml behaviour.
