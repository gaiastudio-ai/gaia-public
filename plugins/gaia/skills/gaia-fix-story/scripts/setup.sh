#!/usr/bin/env bash
# setup.sh — Cluster 7 fix-story skill setup (E28-S55)
#
# Mechanical extension of the Cluster 7 reference implementation authored
# under E28-S52 (gaia-create-story/scripts/setup.sh). Adds fix-story-specific
# prereq gates:
...
SCRIPT_NAME="gaia-fix-story/setup.sh"
WORKFLOW_NAME="fix-story"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-fix-story/scripts/setup.sh → ../../../scripts
