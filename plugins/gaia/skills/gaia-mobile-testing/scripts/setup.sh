#!/usr/bin/env bash
# setup.sh — Cluster 12 gaia-mobile-testing skill setup (E28-S88)
#
...
SCRIPT_NAME="gaia-mobile-testing/setup.sh"
WORKFLOW_NAME="mobile-testing"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-mobile-testing/scripts/setup.sh → ../../../scripts
