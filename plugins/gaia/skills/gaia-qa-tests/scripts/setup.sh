#!/usr/bin/env bash
# setup.sh — Cluster 9 gaia-qa-tests skill setup (E28-S68)
#
# Mechanical extension of the Cluster 9 canonical reference implementation
# authored under E28-S66 (gaia-code-review/scripts/setup.sh). Only
...
SCRIPT_NAME="gaia-qa-tests/setup.sh"
WORKFLOW_NAME="qa-tests"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-qa-tests/scripts/setup.sh → ../../../scripts
...
# No specific gate validation needed beyond what the skill body does.
# The skill body resolves the story file via glob and fails fast if missing.
