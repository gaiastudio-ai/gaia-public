#!/usr/bin/env bash
# setup.sh — Cluster 12 gaia-release-plan skill setup (E28-S93)
#
...
SCRIPT_NAME="gaia-release-plan/setup.sh"
WORKFLOW_NAME="release-plan"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-release-plan/scripts/setup.sh → ../../../scripts
