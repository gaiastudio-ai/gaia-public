...
- Read the PRD at `docs/planning-artifacts/prd/prd.md`.
- If the file does not exist, fail fast: "PRD not found at docs/planning-artifacts/prd/prd.md — run /gaia-create-prd first."
