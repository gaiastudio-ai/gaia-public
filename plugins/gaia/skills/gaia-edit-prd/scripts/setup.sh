...
SCRIPT_NAME="gaia-edit-prd/setup.sh"
WORKFLOW_NAME="edit-prd"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-edit-prd/scripts/setup.sh → ../../../scripts
...
# edit-prd requires an existing prd.md in planning-artifacts.
