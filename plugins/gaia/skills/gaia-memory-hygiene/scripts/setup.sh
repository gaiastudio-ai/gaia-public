...
#
# Fail-fast semantics: if any foundation script is missing or non-executable,
# this setup aborts with a clear message identifying the missing path.
#
# Exit codes:
...
SCRIPT_NAME="gaia-memory-hygiene/setup.sh"
WORKFLOW_NAME="memory-hygiene"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-memory-hygiene/scripts/setup.sh → ../../../scripts
