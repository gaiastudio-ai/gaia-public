#!/usr/bin/env bash
# setup.sh — Cluster 11 gaia-test-gap-analysis skill setup (E28-S84)
#
...
SCRIPT_NAME="gaia-test-gap-analysis/setup.sh"
WORKFLOW_NAME="test-gap-analysis"

# Resolve the GAIA plugin scripts directory from this script's location:
#   skills/gaia-test-gap-analysis/scripts/setup.sh → ../../../scripts
...
# The skill body handles missing test-plan.md gracefully (AC-EC1).
